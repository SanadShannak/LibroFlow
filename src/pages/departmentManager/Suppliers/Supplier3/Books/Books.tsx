...
import { initialBooks, Book } from '../../../../../dummyData/adminPages/supplier3Books';
  ...
  return (
    <MantineProvider>
      <Container fluid className={classes.container}>
        <Box className={classes.header}> {/* Fixed typo: booksData.header to classes.header */}
          <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
            <Box>
              <Title order={3} c="white" mb="xs">Supplier 3 Books</Title>
