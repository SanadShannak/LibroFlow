...
import membersImage from '../../assets/members.svg'; // Placeholder for the members icon
...
const containerShadow = '0 10px 30px rgba(0, 0, 0, 0.25)';
    ...
    <Box p="50">
      ...
      <SimpleGrid cols={{ base: 1, lg: 4 }} spacing="33" mt="2" w={'100%'}>
        <Paper
          ...
          radius="md"
          bg="#37474f"
          style={{ gridColumn: 'span 1', boxShadow: containerShadow }}
        >
        ...
        >
          ...
          <Text size="sm" fw={500} c="#A0AEC0" mb="sm" style={{ position: 'relative', zIndex: 2 }} ta="center">
            Staff Performance
          </Text>
          <Stack gap="sm" style={{ position: 'relative', zIndex: 2 }}>
            <Group justify="space-between">
